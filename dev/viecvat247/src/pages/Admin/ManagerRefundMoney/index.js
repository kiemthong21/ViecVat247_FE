...
const App = () => {
    ...
    useAuthorizationManage("Manager Refund Money");
    ...
    const handleSearch = async () => {
        try {
            ...
            const response = await request.get("Staff/ListAllTransactions?transactionType=4", {
                params: {
                    customerId: null,
    ...
    return (
        <>
            <h2 style={{ color: "#02AA8A", fontWeight: "500" }}> Bảng quản lý giao dịch hoàn tiền của khách hàng</h2>
