...
const App = () => {
    ...
    useAuthorizationManage("Manager Withdraw Money");
    ...
    const handleSearch = async () => {
        try {
            ...
            const response = await request.get("Staff/ListAllTransactions?transactionType=2", {
                params: {
                    customerId: null,
    ...
    return (
        <>
            <h2 style={{ color: "#02AA8A", fontWeight: "500" }}> Bảng quản lý giao dịch rút tiền của khách hàng</h2>
