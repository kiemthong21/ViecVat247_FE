    ...
    return (
        <div className="container">
            <div className="profile">
                <h3 className="profile-tag">Job Assigner Profile</h3>
                <div className="row">
                    ...
                    <div className="col-md-6 mt-1">
                        ...
                        <div className="card mb-3 content">
                            <h5 className="m-3"> Post Activity Received </h5>
                            <div className="card-body">
                                <div className="row">
                            ...
                            <div className="card-body">
                                <div className="row">
                                    <div className="col-md-6 rating">
                                        <img  src={images.logo.default} alt="Rating" />
                                    </div>
...
export default Profileassigner;
